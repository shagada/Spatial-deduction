...
pred=tf.concat([pred16,pred2,pred3,pred4,pred1,pred5,pred6,pred7,pred8,pred21,pred9,pred10,pred11,pred12,pred13,pred14,pred15,pred17],1)
...
with tf.Session() as sess:
    for k in range(436):
        val_loss=[]
        print(k)
        input_data,val_data, test_data = get_data('B3_outer.csv', k)
        ...
        file2 = open('B3_outer_p1.csv', 'a+', newline='')
